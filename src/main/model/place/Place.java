...
public abstract class Place {
    ...
    public void showPlaceInfos() {
        ...
        if (this instanceof PlaceWithClanChief) {
            if(((PlaceWithClanChief) this).getClanChief() != null) {
                System.out. println("Chef: " + ((PlaceWithClanChief) this).getClanChief().getName());
            }
            else{
